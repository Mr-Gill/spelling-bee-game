...
var ScoreCard = ({ participant, isActive }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "div",
    {
      className: `text-center scorecard transition-transform ${isActive ? "border-2 border-yellow-300 rounded-lg shadow-lg scale-105" : ""}`,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "text-2xl font-bold", children: participant.name }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "text-4xl font-bold text-yellow-300", children: "\u2764\uFE0F".repeat(participant.lives) }),
...
var useMusic = (musicStyle, trackVariant, musicVolume, soundEnabled, screen) => {
  ...
  const audioContextRef = (0, import_react20.useRef)(null);
  const audioBufferRef = (0, import_react20.useRef)(null);
  const sourceNodeRef = (0, import_react20.useRef)(null);
  const gainNodeRef = (0, import_react20.useRef)(null);
  ...
  const buildAudioPath = (style, variant) => {
...
var AudioContext = (0, import_react21.createContext)(void 0);
var AudioProvider = ({ children }) => {
  const [muted, setMuted] = (0, import_react21.useState)(false);
  const toggleMute = () => {
    setMuted(!muted);
  };
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(AudioContext.Provider, { value: { muted, toggleMute }, children });
};
