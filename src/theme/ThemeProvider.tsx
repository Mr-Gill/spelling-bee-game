...
const colorThemes = {
  ...
  purple: {
    light: {
      ...
      'primary-hover': 'hsl(262, 83%, 53%)',
      'primary-active': 'hsl(262, 83%, 48%)',
      'primary-subtle': 'hsl(262, 83%, 95%)',
      'primary-container': 'hsl(262, 83%, 90%)',
      'on-primary-container': 'hsl(262, 83%, 20%)',
      'surface': 'hsl(0, 0%, 100%)',
    ...
    dark: {
      ...
      'primary-container': 'hsl(262, 83%, 20%)',
      'on-primary-container': 'hsl(262, 83%, 90%)',
      'surface': 'hsl(0, 0%, 7%)',
