...
const CORRECT_FEEDBACK = [
  ...
  'Correct. That letter arrangement has cleared all internal reviews.',
  'Correct. The word entered the room, sat down, and was immediately verified.',
  'Correct. An extremely organised bee has updated the records accordingly.',
  'Correct. The letters have agreed to appear in that order. This may not last.',
  'Correct. The word appears to be present and accounted for.',
  'Correct. That word did not fight back at all.',
  'Correct. The letters have assembled in the agreed formation.',
  'Correct. Witnessed. Filed. The alphabet has moved on.',
  ...
  'Correct. A small official has initialled the relevant paperwork.',
  'Correct. That spelling went exactly as planned, which was unexpected.',
  'Correct. The word did not have the energy to argue.',
...
const INCORRECT_FEEDBACK = [
  ...
  'Not quite. Several letters have been contacted for comment.',
  ...
  'Nearly. One letter has submitted a formal complaint about its placement.',
  'Incorrect. The alphabet has reviewed the footage and has concerns.',
  'Not quite. A bee with a clipboard has noted this down.',
  ...
  'Not quite. Two letters have requested a meeting.',
