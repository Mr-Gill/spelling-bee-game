...
const CORRECT_FEEDBACK = [
  ...
  'Every letter appeared, and none of them were wrong. This is rarer than it sounds.',
  ...
  'You had the word\'s number. It never stood a chance.',
  'Nice spelling. The alphabet looks relieved.',
  'You heard it, you spelled it. Both things happened in the right order.',
  'That word had a reputation. The reputation was exaggerated.',
  'The letters are in the correct position. That is, specifically, what was required.',
  'Correct. The letters have agreed to appear in that order. This may not last.',
  'You spelled it without the word offering any assistance. The word accepts full responsibility for this.',
  'That word did not fight back at all.',
  'Fast enough. The word had no time to reconsider.',
  'Yes. That is correct. Nothing further is required.',
  'Correct. This was handled. It is now over.',
  'Correct. That is the word. The word acknowledges this.',
  'Correct. The word came in, got spelled, left. Very professional.',
  'The hive detects a correct spelling. It is experiencing mild satisfaction.',
  'Correct. That spelling went exactly as planned, which was unexpected.',
  'The word did not have the energy to argue.',
  'That word is now behind you. Metaphorically and, in a sense, literally.',
  'Well done. The word won\'t say it. But we can say it on its behalf.',
  'The word posed no further problems.',
  'Correct. The hive is pleased. Briefly, but genuinely.',
  'Correct. The bee has given this a small waggle dance of approval.',
  'Somewhere, a dictionary relaxes slightly.',
...
const INCORRECT_FEEDBACK = [
  'The word was not persuaded. Try a different arrangement.',
  ...
  'The word observed that and is ready to be tried again.',
  'Incorrect. The letters were close to an agreement but could not finalise.',
  'Not this time. The word watched and said nothing, which felt pointed.',
  'Something was slightly off. This was almost the spelling, but not quite the spelling.',
  'Incorrect. The alphabet has reviewed the footage and has concerns.',
  'Wrong this time. Commit the word to memory and go again.',
  'The word was present. The spelling was also present. They did not coordinate.',
  'Incorrect. The word remains in the room, not making eye contact.',
  'Not quite. The spelling left the building slightly before it finished.',
  'Incorrect. That attempt has been received and is being processed.',
  'Close. The letters met in the middle and made a decision the word did not endorse.',
  'Not quite. The word would like to try again, but that is not how this works.',
  'Incorrect. The word was there the whole time, waiting patiently.',
  'Some of the letters showed up. The rest were still deciding.',
  'Incorrect. The word has seen better spellings of itself, but remains polite.',
  'Close. The word filled out an expression of interest but could not commit.',
  'That answer was not quite right. The correct one is close. Keep going.',
  ...
  'Not this time. The word requires its letters in a specific order. That\'s the whole thing.',
